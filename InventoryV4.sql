...
INSERT INTO `order` VALUES (1,1,5,'2016-10-07','10:55:21'),(2,2,4,'2016-08-13','13:34:54'),(3,3,3,'2016-10-19','12:05:01'),(4,4,2,'2015-03-07','00:00:33'),(5,5,1,'2015-02-14','14:54:45'),(6,1,1,'2016-12-04','16:15:38'),(7,2,1,'2016-12-04','17:16:03'),(8,1,1,'2016-12-04','17:29:49');
...
INSERT INTO `order_details` VALUES (1,1,1),(1,2,1),(1,3,1),(1,4,1),(1,5,1),(2,4,1),(2,5,1),(3,2,2),(4,1,5),(4,2,3),(5,1,1),(6,1,2);
...
INSERT INTO `part` VALUES (1,'Core i7-6950X Processor','Intel',2299.99,98,'P4','CPU'),(2,'GeForce GTX 1080 FTW HYBRID Gaming 8GB PCI-E w/ Triple DP, DVI, HDMI ','EVGA',999.99,2,'G10','GPU'),(3,'Dominator Platinum Series 128GB PC4-19200 DDR4 Kit (8 x 16GB)','Corsair',1244.99,1,'R2','RAM'),(4,'AXi Series AX1500i Modular Digital Power Supply','Corsair',499.99,3,'PS1','PSU'),(5,'10TB Enterprise 3.5in HDD SATA III w/ 512e / 4Kn Formatting, 256MB Cache','Nvidia',799.99,1,'S10','HDD');
...
CREATE TABLE `hdd` (
  ...
  PRIMARY KEY (`part_id`),
  CONSTRAINT `part_id_hdd` FOREIGN KEY (`part_id`) REFERENCES `part` (`part_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
...
CREATE TABLE `gpu` (
  ...
  PRIMARY KEY (`part_id`),
  CONSTRAINT `part_id_gpu` FOREIGN KEY (`part_id`) REFERENCES `part` (`part_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `gpu` VALUES (2,'8192','10000');
...
CREATE TABLE `cpu` (
  ...
  PRIMARY KEY (`part_id`),
  CONSTRAINT `part_id_cpu` FOREIGN KEY (`part_id`) REFERENCES `part` (`part_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `cpu` VALUES (1,'3.0','10','20');
...
CREATE TABLE `psu` (
  ...
  PRIMARY KEY (`part_id`),
  CONSTRAINT `part_id_psu` FOREIGN KEY (`part_id`) REFERENCES `part` (`part_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `psu` VALUES (4,'1500','Yes','Titanium');
...
CREATE TABLE `ram` (
  ...
  PRIMARY KEY (`part_id`),
  CONSTRAINT `part_id_ram` FOREIGN KEY (`part_id`) REFERENCES `part` (`part_id`) ON DELETE CASCADE ON UPDATE CASCADE
